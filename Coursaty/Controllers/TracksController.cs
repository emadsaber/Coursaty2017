...
namespace Coursaty.Controllers
{
    public class TracksController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,name,parentTrack,ToDelete")] Track track)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,name,parentTrack,ToDelete")] Track track)
        {
            if (ModelState.IsValid)
            {
